...
import 'package:flutter_redsocial_final/domain/models/public_job.dart';
import 'package:flutter_redsocial_final/domain/services/misiontic_interface.dart';
import 'package:http/http.dart' as http;

class WorkPoolService implements MisionTicService {
  final String baseUrl = 'misiontic-2022-uninorte.herokuapp.com';
  final String apiKey = '95OxepWq48py9Nq60954GuZ9a4acbFxZpX1LE2CQeS8Jl5K25QmU6';
